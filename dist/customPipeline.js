...
function main() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var account, accountKey, sharedKeyCredential, pipeline, blobServiceClient, i, _b, _c, container, e_1_1, containerName, containerClient, createContainerResponse;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    pipeline = storage_blob_1.newPipeline(sharedKeyCredential, {
                        // httpClient: MyHTTPClient, // A customized HTTP client implementing IHttpClient interface
                        retryOptions: { maxTries: 4 },
                        userAgentOptions: { userAgentPrefix: "Sample V1.0.0" } // Customized telemetry string
                    });
                    blobServiceClient = new storage_blob_1.BlobServiceClient("https://" + account + ".blob.core.windows.net", pipeline);
                    i = 1;
                    _d.label = 1;
                case 1:
