...
function main() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var account, accountSas, anonymousCredential, blobServiceClient, i, _b, _c, container, e_1_1, containerName, containerClient, createContainerResponse;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    account = process.env.ACCOUNT_NAME || "";
                    accountSas = process.env.ACCOUNT_SAS || "";
                    anonymousCredential = new storage_blob_1.AnonymousCredential();
                    blobServiceClient = new storage_blob_1.BlobServiceClient(
                    // When using AnonymousCredential, following url should include a valid SAS or support public access
                    "https://" + account + ".blob.core.windows.net" + accountSas, anonymousCredential);
                    i = 1;
                    _d.label = 1;
                case 1:
